...
void led_strip_set_color(uint16_t index, uint32_t color) {
	...
	color >>= 8;
	led_strip_buffer[index + 3] = color & 0xFF;
	led_strip_refresh();
	delay(1000);
}
...
void loop() {
	// led_strip_set_color(0, 0x00000000);
	// led_strip_set_color(0, 0x000000FF);
	// led_strip_set_color(0, 0x1F0000FF);
	// led_strip_set_color(0, 0x0000FF00);
	// led_strip_set_color(0, 0x1F00FF00);
	// led_strip_set_color(0, 0x00FF0000);
	// led_strip_set_color(0, 0x1FFF0000);
	led_strip_set_color(0, 0xFF000000);
	led_strip_set_color(0, 0x00FFFFFF);
	// led_strip_set_color(0, 0xFFFFFFFF);
	// delay(4000);
}
