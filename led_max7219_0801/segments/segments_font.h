/*
	TM1638 V0.0.0.1 Class!
	==========================
	Copyright (C) 2013 Arad Eizen (A.E Tec) LTD INC.
	This Program Runs The LKM1638 Display Module!
	Main Chip: TM1638.
	Language: cxx
...
#ifndef _SEGMENTS_FONT_h_
#define _SEGMENTS_FONT_h_

// displayable ASCII chars
const uint8_t SEGMENTS_FONT[] PROGMEM = {
  0b00000000, // (32)	<space>
  0b10000110, // (33)	!
  0b00100010, // (34)	"
  0b01111110, // (35)	#
