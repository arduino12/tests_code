...
void setup() {
	...
	rgb_color_t rgb_colors[6] = {};
	led_effects_set_fix_ms(0, 10, 1000, 0, rgb_colors, sizeof(rgb_colors));
	
	for (uint8_t j = 0; j < 10; j++)
		for (uint8_t i = 0; i < COLOR_CHANNEL_COUNT; i++) {
			(*led_strip_buffer).r = i;
			(*led_strip_buffer).g = i;
			(*led_strip_buffer).b = i;
