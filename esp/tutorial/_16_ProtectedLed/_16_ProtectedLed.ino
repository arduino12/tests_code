...
void loop() {
  ...
  if(pos) {
    ...
    if(password_valid == true) bfill.emit_p(PSTR("<div><input type=\"text\" name=\"pwd\"></div></form></body></html>"));
    else bfill.emit_p(PSTR("<div><input type=\"text\" name=\"pwd\">Wrong password</div></form></body></html>"));
